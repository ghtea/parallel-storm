...
const TeamGenerator = ({match, location, rerenderPlanTeam, loading, ready, authority, replaceData, planTeam, readPlanTeam, addRemoveNotification, replaceReady, replaceLoading}) => {
  ...
  useEffect( () => {onPlanTeam()}, [window.location.pathname]);
